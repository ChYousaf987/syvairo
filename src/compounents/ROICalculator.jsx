...
const ROICalculator = () => {
  ...
  return (
    <>
      <section id="roi-calculator" className="bgGradient py-7 min-h-screen  ">
        <div className="flex flex-col items-center px-3">
          ...
          <div className="max-w-3xl w-full text-center mb-12">
            ...
            >
              Use our calculator to discover the potential Return on Investment
              of AI automation for your business.
            </motion.p>
          </div>

          {/* Input Card */}
          <div
            className="rounded-xl p-3 md:p-8 w-full max-w-xl shadow-md"
            style={{
